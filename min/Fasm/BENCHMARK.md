...
| sqw (1500) | 40.1 ms | 43.3 ms | **1.08×** | **faster**: fused verify + inlined ref_ok + honest O8 (cost C its DCE) |
...
Honest read: 4 wins, 2 parity, 0 losses — every system at parity
or better. (sqw moved from 0.73× to 1.08×; sq2b and sq5 reached
parity earlier this session.)
