...
__global__ __launch_bounds__(256, 2) void slab_correctness_kernel(SlabPool* pool, uint32_t iters,
                                         uint32_t* d_errors) {
...
__global__ __launch_bounds__(256, 2) void slab_tput_kernel(SlabPool* pool, int cls,
...
__global__ __launch_bounds__(256, 2) void slab_stress_kernel(SlabPool* pool, uint32_t iters,
                                    uint32_t* d_cnt) {
